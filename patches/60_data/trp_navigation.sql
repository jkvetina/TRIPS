BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('-- MERGE ' || UPPER('trp_navigation'));
    DBMS_OUTPUT.PUT_LINE('--');
END;
/
--
DELETE FROM trp_navigation;
--
MERGE INTO trp_navigation t
USING (
    ...
    SELECT 980 AS page_id, NULL AS parent_id, NULL AS is_hidden, 'Y' AS is_reset, 980 AS order# FROM DUAL UNION ALL
