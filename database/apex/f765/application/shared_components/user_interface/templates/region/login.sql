...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45479098610075267)
,p_layout=>'TABLE'
...
,p_reference_id=>38018816530322365
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49252129345406122)
,p_plug_template_id=>wwv_flow_imp.id(45479098610075267)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49252604370406122)
,p_plug_template_id=>wwv_flow_imp.id(45479098610075267)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49253055230406123)
,p_plug_template_id=>wwv_flow_imp.id(45479098610075267)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49253582764406123)
,p_plug_template_id=>wwv_flow_imp.id(45479098610075267)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49254042542406123)
,p_plug_template_id=>wwv_flow_imp.id(45479098610075267)
,p_name=>'Sub Regions'
