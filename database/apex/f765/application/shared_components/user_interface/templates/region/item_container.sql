...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45476628796075266)
,p_layout=>'TABLE'
...
,p_reference_id=>37970563927322340
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49245267034406117)
,p_plug_template_id=>wwv_flow_imp.id(45476628796075266)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49245753090406117)
,p_plug_template_id=>wwv_flow_imp.id(45476628796075266)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49246328856406118)
,p_plug_template_id=>wwv_flow_imp.id(45476628796075266)
,p_name=>'Button Start'
