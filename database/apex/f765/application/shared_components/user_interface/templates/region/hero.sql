...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45451267875075251)
,p_layout=>'TABLE'
...
,p_reference_id=>38015570749322362
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49181522072406071)
,p_plug_template_id=>wwv_flow_imp.id(45451267875075251)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49181993948406072)
,p_plug_template_id=>wwv_flow_imp.id(45451267875075251)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49182455938406072)
,p_plug_template_id=>wwv_flow_imp.id(45451267875075251)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49182939877406072)
,p_plug_template_id=>wwv_flow_imp.id(45451267875075251)
,p_name=>'Sub Regions'
