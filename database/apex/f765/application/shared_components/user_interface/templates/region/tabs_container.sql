...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45494123277075276)
,p_layout=>'TABLE'
...
,p_reference_id=>37985559835322347
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49291956368406152)
,p_plug_template_id=>wwv_flow_imp.id(45494123277075276)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49292452947406152)
,p_plug_template_id=>wwv_flow_imp.id(45494123277075276)
,p_name=>'Tabs'
