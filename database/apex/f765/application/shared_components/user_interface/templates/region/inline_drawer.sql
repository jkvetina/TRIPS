...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45464474474075259)
,p_layout=>'TABLE'
...
,p_reference_id=>37958296926322333
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49215479324406096)
,p_plug_template_id=>wwv_flow_imp.id(45464474474075259)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49215991994406097)
,p_plug_template_id=>wwv_flow_imp.id(45464474474075259)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49216476404406097)
,p_plug_template_id=>wwv_flow_imp.id(45464474474075259)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49216997620406097)
,p_plug_template_id=>wwv_flow_imp.id(45464474474075259)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49217485946406097)
,p_plug_template_id=>wwv_flow_imp.id(45464474474075259)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49217990522406098)
,p_plug_template_id=>wwv_flow_imp.id(45464474474075259)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49218472478406098)
,p_plug_template_id=>wwv_flow_imp.id(45464474474075259)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49219007631406098)
,p_plug_template_id=>wwv_flow_imp.id(45464474474075259)
,p_name=>'Sub Regions'
