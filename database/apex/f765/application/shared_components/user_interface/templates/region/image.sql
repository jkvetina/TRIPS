...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45454491745075254)
,p_layout=>'TABLE'
...
,p_reference_id=>37952914387322328
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49188465034406076)
,p_plug_template_id=>wwv_flow_imp.id(45454491745075254)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49188993492406077)
,p_plug_template_id=>wwv_flow_imp.id(45454491745075254)
,p_name=>'Sub Regions'
