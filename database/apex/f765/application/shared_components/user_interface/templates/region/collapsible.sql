...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45437208392075243)
,p_layout=>'TABLE'
...
,p_reference_id=>37997474496322353
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49146643061406045)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49147162960406046)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49147712785406046)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49148204343406046)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49148696513406047)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49149196758406047)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49149698235406047)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49150171942406047)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49150714305406048)
,p_plug_template_id=>wwv_flow_imp.id(45437208392075243)
,p_name=>'Sub Regions'
