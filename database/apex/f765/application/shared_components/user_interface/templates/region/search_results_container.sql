...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45481561243075269)
,p_layout=>'TABLE'
...
,p_reference_id=>37973102026322341
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49257905316406126)
,p_plug_template_id=>wwv_flow_imp.id(45481561243075269)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49258381763406127)
,p_plug_template_id=>wwv_flow_imp.id(45481561243075269)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49258936243406127)
,p_plug_template_id=>wwv_flow_imp.id(45481561243075269)
,p_name=>'Sub Regions'
