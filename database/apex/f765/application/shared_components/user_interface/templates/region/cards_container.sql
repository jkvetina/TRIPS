...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(45425402303075235)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49114926469406022)
,p_plug_template_id=>wwv_flow_imp.id(45425402303075235)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49115370590406022)
,p_plug_template_id=>wwv_flow_imp.id(45425402303075235)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49115930604406023)
,p_plug_template_id=>wwv_flow_imp.id(45425402303075235)
,p_name=>'Sub Regions'
