...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(45411562835075221)
,p_theme_id=>700
...
,p_reference_id=>37931436979322312
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49073949651405993)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49074510492405993)
,p_page_template_id=>wwv_flow_imp.id(45411562835075221)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49075006292405994)
,p_page_template_id=>wwv_flow_imp.id(45411562835075221)
