...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(45389606943075209)
,p_theme_id=>700
,p_name=>'Login'
...
,p_reference_id=>37927335726322309
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49013879354405952)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49014401665405952)
,p_page_template_id=>wwv_flow_imp.id(45389606943075209)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49014919138405953)
,p_page_template_id=>wwv_flow_imp.id(45389606943075209)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49015343668405953)
,p_page_template_id=>wwv_flow_imp.id(45389606943075209)
,p_name=>'Body Footer'
