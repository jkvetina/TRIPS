prompt --application/shared_components/user_interface/templates/page/standard_qnav
begin
--   Manifest
--     TEMPLATE: STANDARD_QNAV
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(49075986562405994)
,p_theme_id=>700
,p_name=>'Standard Q-NAV'
,p_internal_name=>'STANDARD_QNAV'
,p_is_popup=>false
...
,p_reference_id=>37801187493585072
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49076526465405995)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49076963629405995)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49077536621405996)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49078010493405996)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49078451370405996)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49079030640405997)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49079478617405997)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49080030926405997)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49080485195405997)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49080975408405998)
,p_page_template_id=>wwv_flow_imp.id(49075986562405994)
