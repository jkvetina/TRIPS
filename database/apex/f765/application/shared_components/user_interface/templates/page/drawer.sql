...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(45378986090075202)
,p_theme_id=>700
,p_name=>'Drawer'
...
,p_reference_id=>37902155270322283
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(48984713117405932)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(48985203588405932)
,p_page_template_id=>wwv_flow_imp.id(45378986090075202)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(48985715217405932)
,p_page_template_id=>wwv_flow_imp.id(45378986090075202)
