...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(45399604373075215)
,p_theme_id=>700
,p_name=>'Modal Dialog'
...
,p_reference_id=>37929878278322311
);
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49040696204405971)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49041202458405971)
,p_page_template_id=>wwv_flow_imp.id(45399604373075215)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(49041677591405971)
,p_page_template_id=>wwv_flow_imp.id(45399604373075215)
